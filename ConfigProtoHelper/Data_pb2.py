...
_ROLECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='AvoidAbility', full_name='RoleConfig.AvoidAbility', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='Radius', full_name='RoleConfig.Radius', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='BaseHP', full_name='RoleConfig.BaseHP', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='BaseAttack', full_name='RoleConfig.BaseAttack', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='BaseDefend', full_name='RoleConfig.BaseDefend', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='GrowHPByLevel', full_name='RoleConfig.GrowHPByLevel', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='GrowAttackByLevel', full_name='RoleConfig.GrowAttackByLevel', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='GrowDefendByLevel', full_name='RoleConfig.GrowDefendByLevel', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='GrowHPByStar', full_name='RoleConfig.GrowHPByStar', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='GrowAttackByStar', full_name='RoleConfig.GrowAttackByStar', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='GrowDefendByStar', full_name='RoleConfig.GrowDefendByStar', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='RoleType', full_name='RoleConfig.RoleType', index=16,
...
_DATAHELPER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='RoleConfig_dict', full_name='DataHelper.RoleConfig_dict', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='BuffConfig_dict', full_name='DataHelper.BuffConfig_dict', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='MoveActionTimelineNode_dict', full_name='DataHelper.MoveActionTimelineNode_dict', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='AbilityConfig_dict', full_name='DataHelper.AbilityConfig_dict', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='Timeline_dict', full_name='DataHelper.Timeline_dict', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='HitCheckInfo_dict', full_name='DataHelper.HitCheckInfo_dict', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='AbilityEffect_dict', full_name='DataHelper.AbilityEffect_dict', index=7,
      number=8, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='VectorInt3_dict', full_name='DataHelper.VectorInt3_dict', index=8,
      number=9, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='InputActionTimelineNode_dict', full_name='DataHelper.InputActionTimelineNode_dict', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='LockActionNode_dict', full_name='DataHelper.LockActionNode_dict', index=10,
  ...
  nested_types=[_DATAHELPER_ROLECONFIGDICTENTRY, _DATAHELPER_BUFFCONFIGDICTENTRY, _DATAHELPER_MOVEACTIONTIMELINENODEDICTENTRY, _DATAHELPER_ABILITYCONFIGDICTENTRY, _DATAHELPER_TIMELINEDICTENTRY, _DATAHELPER_HITCHECKINFODICTENTRY, _DATAHELPER_ABILITYEFFECTDICTENTRY, _DATAHELPER_VECTORINT3DICTENTRY, _DATAHELPER_INPUTACTIONTIMELINENODEDICTENTRY, _DATAHELPER_LOCKACTIONNODEDICTENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
