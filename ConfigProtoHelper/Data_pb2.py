...
_DATAHELPER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='VectorInt3_dict', full_name='DataHelper.VectorInt3_dict', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='HitCheckInfo_dict', full_name='DataHelper.HitCheckInfo_dict', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='RoleConfig_dict', full_name='DataHelper.RoleConfig_dict', index=3,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='MoveActionTimelineNode_dict', full_name='DataHelper.MoveActionTimelineNode_dict', index=5,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='AbilityConfig_dict', full_name='DataHelper.AbilityConfig_dict', index=8,
      number=9, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='InputActionTimelineNode_dict', full_name='DataHelper.InputActionTimelineNode_dict', index=10,
  ...
  nested_types=[_DATAHELPER_VECTORINT3DICTENTRY, _DATAHELPER_HITCHECKINFODICTENTRY, _DATAHELPER_ROLECONFIGDICTENTRY, _DATAHELPER_TIMELINEDICTENTRY, _DATAHELPER_MOVEACTIONTIMELINENODEDICTENTRY, _DATAHELPER_BUFFCONFIGDICTENTRY, _DATAHELPER_ABILITYEFFECTDICTENTRY, _DATAHELPER_ABILITYCONFIGDICTENTRY, _DATAHELPER_LOCKACTIONNODEDICTENTRY, _DATAHELPER_INPUTACTIONTIMELINENODEDICTENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
